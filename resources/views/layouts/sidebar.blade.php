<aside class="w-64 bg-gray-800 border-r border-gray-700 flex flex-col justify-between shrink-0 min-h-[calc(100vh-4rem)]">
    ...
    <div class="p-4 border-t border-gray-700 text-center text-xs text-gray-500 font-mono">
        RENOSA © 2026
    </div>
</aside>