    ...
    @forelse($registros as$row)
        <div class="bg-gray-800/80 border border-gray-700/60 rounded-xl p-4 shadow-md">
            <div class="flex justify-between items-start mb-3 border-b border-gray-700/50 pb-2">
                ...
                <span class="text-emerald-400 font-bold font-mono text-base">${{ number_format($row->total_carga ?? 0, 2) }}</span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-2 text-xs mb-3">
                ...
                <div>
                    ...
                    <span class="text-gray-300 font-mono">{{ number_format($row->kilometraje ?? 0) }} km</span>
                </div>
            </div>
        ...
        <tbody class="divide-y divide-gray-800">
            @forelse($registros as$row)
                <tr class="hover:bg-gray-800/50 transition">
                    ...
                    <td class="px-4 py-3 font-mono text-xs whitespace-nowrap">{{ number_format($row->kilometraje ?? 0) }} km</td>
                    ...
                    <td class="px-4 py-3 font-mono text-xs whitespace-nowrap">${{ number_format($row->precio_galon ?? 0, 2) }}</td>
                    <td class="px-4 py-3 text-emerald-400 font-bold text-right font-mono whitespace-nowrap">${{ number_format($row->total_carga ?? 0, 2) }}</td>
