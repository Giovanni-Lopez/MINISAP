...
<div class="max-w-3xl w-full">
    ...
    <div class="bg-gray-900 border border-gray-800 p-8 rounded-2xl shadow-2xl">
        ...
        <form action="{{ route('km.store') }}" method="POST" class="space-y-5">
            ...
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-4 rounded-xl transition flex items-center justify-center gap-2 text-sm shadow-lg shadow-blue-900/30 mt-2 cursor-pointer">
