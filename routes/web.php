...
// Alias /usuarios para evitar error 404
Route::redirect('/usuarios', '/gestion-usuarios');
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => function ($request, $next) {
        ...
        Route::get('/gestion-usuarios/{id}/edit', [UserController::class, 'edit'])->name('gestion-usuarios.edit');
    ...
    // Registro de Motoristas / Conductores
    ...
    // 7. Registro de Kilometraje Diario
    ...
    Route::delete('/licencias/{id}', [LicenciaController::class, 'destroy'])->name('licencias.destroy');
